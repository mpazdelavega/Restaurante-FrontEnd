...
const Prueba = () => {
  ...
  <div class="container mx-auto xl:pb-16 mt-10">
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        ...
        <a href="/#" class="flex font-semibold text-amber-600 text-sm mt-10">
      
          <svg class="fill-current mr-2 text-amber-600 w-4" viewBox="0 0 448 512"><path d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z"/></svg>
          Continue Shopping
        </a>
      </div>
      ...
      <div id="summary" class="w-1/4 px-8 py-10">
        ...
        <div class="border-t mt-8">
          ...
          <button class="bg-amber-600 font-semibold hover:bg-amber-900 transition-colors py-3 text-sm text-white uppercase w-full">Checkout</button>
        </div>
      </div>
